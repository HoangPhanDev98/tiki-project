...
function Footer(props) {
  return (
    <Paper sx={{ marginTop: "16px" }}>
      ...
      >
        <Box>
          <Typography className="footer__header">Hỗ trợ khách hàng</Typography>
          <Link className="footer__link" href="#">
            Hotline: <b>1900-6035</b> <br />
        ...
        <Box>
          <Typography className="footer__header">Về Tiki</Typography>
          <Link className="footer__link" href="#">
            Giới thiệu về Tiki
          </Link>
          <Link className="footer__link" href="#">
          ...
          <Link className="footer__link" href="#">
            Gói các thành viên đặc quyền - Astra Rewards
          </Link>
          <Link className="footer__link" href="#">
